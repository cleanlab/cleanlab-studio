...
class TLMHybrid:
    ...
    ** The TLMHybrid object is not meant to be constructed directly.** Instead, use the [`Studio.TLMHyrid()`](../studio/#method-tlmhyrid)
    method to configure and instantiate a TLMHybrid object.
    After you've instantiated the TLMHybrid object using [`Studio.TLMHybrid()`](../studio/#method-tlmhyrid), you can use the instance methods documented on this page.
    ...
    def __init__(
        ...
        *,
        ...
        self._timeout = timeout  # TODO: are we handling this any differently?
    ...
    def prompt(
        ...
        This method prompts one LLM with the given prompt(s), producing completions (like a standard LLM)
        and then uses a second LLM to perform an evaluation of the given response and provides a trustworthiness scores quantifying the quality of the output.

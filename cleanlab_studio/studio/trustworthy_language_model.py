...
class TLMOptions(TypedDict):
    ...
    Args:
        model ({"gpt-4o-mini", "gpt-4o", "o1-preview", "gpt-3.5-turbo-16k", "gpt-4", "claude-3.5-sonnet", "claude-3-haiku", "o1", "o1-mini", "claude-3.5-sonnet-v2", "claude-3.5-haiku", "nova-micro", "nova-lite", "nova-pro"}, default = "gpt-4o-mini"):
        Underlying base LLM to use (better models yield better results, faster models yield faster/cheaper results).
        - Models still in beta are: "o1", "o1-mini", "claude-3.5-sonnet-v2", "claude-3.5-haiku", "nova-micro", "nova-lite", "nova-pro".
